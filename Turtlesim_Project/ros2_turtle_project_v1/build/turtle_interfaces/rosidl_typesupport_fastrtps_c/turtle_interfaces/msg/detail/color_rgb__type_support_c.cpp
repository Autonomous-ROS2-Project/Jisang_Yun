...
#include "turtle_interfaces/msg/detail/color_rgb__rosidl_typesupport_fastrtps_c.h"
...
using _ColorRGB__ros_msg_type = turtle_interfaces__msg__ColorRGB;
  ...
  void * untyped_ros_message)
{
  ...
  _ColorRGB__ros_msg_type * ros_message = static_cast<_ColorRGB__ros_msg_type *>(untyped_ros_message);
  // Field name: r
  {
    cdr >> ros_message->r;
  }
...
size_t get_serialized_size_turtle_interfaces__msg__ColorRGB(
  const void * untyped_ros_message,
...
static uint32_t _ColorRGB__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtle_interfaces__msg__ColorRGB(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtle_interfaces
size_t max_serialized_size_turtle_interfaces__msg__ColorRGB(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces__msg__ColorRGB;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
static size_t _ColorRGB__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtle_interfaces__msg__ColorRGB(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtle_interfaces, msg, ColorRGB)() {
