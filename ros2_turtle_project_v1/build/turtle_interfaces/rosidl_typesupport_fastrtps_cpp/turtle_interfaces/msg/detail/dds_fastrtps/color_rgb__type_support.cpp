...
#include "turtle_interfaces/msg/detail/color_rgb__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtle_interfaces::msg::ColorRGB & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtle_interfaces::msg::ColorRGB & ros_message)
{
  // Member: r
  cdr >> ros_message.r;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtle_interfaces::msg::ColorRGB;
    is_plain =
      (
      offsetof(DataType, b) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const turtle_interfaces::msg::ColorRGB *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtle_interfaces::msg::ColorRGB *>(
    untyped_ros_message);
...
{
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_ColorRGB__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtle_interfaces, msg, ColorRGB)() {
  return &turtle_interfaces::msg::typesupport_fastrtps_cpp::_ColorRGB__handle;
}
